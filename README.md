...
boot.py -- makes it possible for python to release the file system when the Circuit Playground Switch is slid to the right and the reset button is brielfy pressed so that pgm.txt can be updated 
