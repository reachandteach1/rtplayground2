...
#neopixels
pixels = NeoPixel(board.NEOPIXEL, 10, brightness=0.2, auto_write=True)
...
pwm = PWMOut(board.A2, duty_cycle=2 ** 15, frequency=50)
my_servo = servo.Servo(pwm)

# ext in
extIn = AnalogIn(board.A1)
